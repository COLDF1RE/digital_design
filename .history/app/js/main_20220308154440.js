$(function () {
  ...
  const menuLinks = document.querySelectoral('.menu__link')
  for (const menuLink of menuLinks) {
    //menuLink.addEventListener('click', changeClassMenu())
  }  

  menuButtonClose.onclick = menuButton.onclick = changeClassMenu
